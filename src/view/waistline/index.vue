<template>
  <div class="shoulder">
     ...
     <div style="height:46px"></div>
      <div class="bj">
          <van-image width="100%" :src="require('../../assets/measure_waistline.jpg')" />
      </div>
      <div class="text">
          <h5>测 量 方 法</h5>
          <p>将卷尺放在髋骨上部和胸腔下部中间的地方，贴紧皮肤<br>但不要勒紧。在呼气状态下读取测量值，精确到O.1cm</p>
      </div>
      <div class="foot">
         <p>添加腰围</p>
         <div class="inp">
              <van-field v-model="number" type="number" placeholder="单位:cm"/>
         </div>
         <div class="next">
             <span @click="changenext">下一步 </span>
...
.foot{
    ...
    height:178px;
    margin-top:30px;
    background:url('../../assets/crry.jpg') no-repeat;

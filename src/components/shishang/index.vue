...
<div class="shishang">
 <div class="home" >
     ...
     <div class="content" :class="{rightmove:this.show==true}">
     <van-row  justify="space-around" gutter="15">
        <van-col span="12">
            <van-image
              ...
              width="100%"
                height="100%"
                 @click="$router.push('/home/shishang/id')"
             :src="require('../../assets/images/时尚_01.jpg')"
            />
        </van-col>
        <van-col span="12" >
             <van-image
              width="100%"
             :src="require('../../assets/images/时尚精选_03.jpg')"
            />
        </van-col>
         <van-col span="12" >
             <van-image
